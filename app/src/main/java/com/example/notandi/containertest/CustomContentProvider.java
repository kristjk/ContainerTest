...
public class CustomContentProvider extends ContentProvider {
    private static final String AUTHORITY = "com.exapmle.containertest.CustomContactsProvider";
    ...
    private class Contact{
        Contact(int i, String n){_id = i; name = n;}
        int _id;
        String name;
    }
    ...
    public boolean onCreate() {
        ...
        mData.add(new Contact(++id_counter, "KK hinn fyrsti"));
        mData.add(new Contact(++id_counter, "KK hinn næsti"));
        return true;
    }
